...
```swift
.package(url: "https://github.com/zilmarinen/Mercator.git", .upToNextMinor(from: "0.1.0")),
```
...
The Mercator framework is primarily the work of [Zack Brown](https://github.com/zilmarinen).
